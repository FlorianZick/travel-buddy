 ...
 */
function createRoutineMachineLayer(): any {
 ...
 * @returns marker
 */
function customCreateMarker(i: number, wp: any, n: number): any {
  if (i === 0 || i < n - 1) {
 ...
 * @param pos position
 */
export function setCurrentPosition(pos: any): void {
 ...
 */
export function getCurrentPosition(): any {
 ...
 * @param pos position
 */
export function setDestinationPosition(pos: any): void {
  let curPos = routingControl.getWaypoints()[0].latLng;
  if (curPos !== null) {
 ...
 */
export function exportRoute(navigator: NavigatorApp): void {
